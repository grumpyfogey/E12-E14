...
set xlabel "Diodenspannung (V)" 
set xlabel  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set x2label "" 
set x2label  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set xrange [ * : * ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
set ylabel "Strom durch Diode (mA)" 
...
set term svg 
set output 'C:\Users\gerald\Praktikum\E12-E14\Diodenkennlinien.svg'
plot 'C:\Users\gerald\Praktikum\E12-E14\Diodenkennlinien.dat' u 1:($2*100)  w l t "richtig gemessene Diodenkennlinie", '' u 3:($4*100) w l t "gemessen mit Trenntrafo"
